...
export default function App() {
  ...
  const searchCars = async (o = opt) => {
    const sys = "Você é assistente de cotação. Responda APENAS com array JSON puro. Cada item: {company, model, dailyRate, link}. Pesquise 1 opção de cada locadora: Movida, Localiza e KINTO. dailyRate número BRL. link: Movida=https://www.movida.com.br, Localiza=https://www.localiza.com, KINTO=https://www.kintobrasil.com.br";
